...
class Restaurant(models.Model):
    ...
    is_package_possible = models.TextField(choices=STATUS_CHOICES, verbose_name='포장 가능 여부', )
    is_delivery_possible = models.TextField(choices=STATUS_CHOICES, verbose_name='배달 가능 여부', )
    is_eating_lonely_possible = models.TextField(choices=STATUS_CHOICES, verbose_name='혼밥 가능 여부', )
